...
public class SqlOptionFilterItem
{
    ...
    public static bool operator ==(SqlOptionFilterItem x, SqlOptionFilterItem y) => Object.Equals(x, y);

    public static bool operator !=(SqlOptionFilterItem x, SqlOptionFilterItem y) => !(x == y);

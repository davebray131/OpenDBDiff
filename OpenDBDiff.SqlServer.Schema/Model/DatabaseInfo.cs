...
public class DatabaseInfo
{
    ...
    public DatabaseInfo() => Version = SQLServerVersion.SQLServer2005;
    ...
    public float VersionNumber
    {
        ...
        set
        {
            ...
            if (versionNumber >= 8)
            {
                version = SQLServerVersion.SQLServer2000;
            }
            ...
            {
                version = SQLServerVersion.SQLServer2014;
            }

            if (versionNumber >= 13.0)
            {
                version = SQLServerVersion.SQLServer2016;
            }

            if (versionNumber >= 14.0)
            {
                version = SQLServerVersion.SQLServer2017;
            }

            if (versionNumber >= 15.0)
            {
                version = SQLServerVersion.SQLServer2019;
            }

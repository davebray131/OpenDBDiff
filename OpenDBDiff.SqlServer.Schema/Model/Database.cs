...
public class Database : SQLServerSchemaBase, IDatabase
{
    ...
    IOption IDatabase.Options => Options;
    ...
    private List<DatabaseChangeStatus> ChangesOptions { get; }
    ...
    public bool IsCaseSensitive
    {
        get
        {
            ...
            return Options.Comparison.CaseSensityType == SqlOptionComparison.CaseSensityOptions.Automatic
                ? isCS
                : Options.Comparison.CaseSensityType == SqlOptionComparison.CaseSensityOptions.CaseSensity || (Options.Comparison.CaseSensityType == SqlOptionComparison.CaseSensityOptions.CaseInsensity && false);
        }
    }
...
";
    ...
    public void BuildDependency()
    {
        ...
        {
            schema = index.Parent;
            foreach (var icolumn in index.Columns)
            {
        ...
        foreach (var con in constraints)
        {
            ...
            {
                foreach (var ccolumn in con.Columns)
                {
